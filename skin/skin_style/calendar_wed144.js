...
function calendar_set(e)
{
	...
	var click_obj = document.getElementById('div_calendar');
 ...
 */
    ...
    html += "<th style='color:#e97265;width:14.28%;	font-family:SMSEMyungJoStd-Regular-FD1;'>일</th>";
    html += "<th style='width:14.28%;font-family:SMSEMyungJoStd-Regular-FD1;'>월</th>";
    html += "<th style='width:14.28%;font-family:SMSEMyungJoStd-Regular-FD1;'>화</th>";
    html += "<th style='width:14.28%;font-family:SMSEMyungJoStd-Regular-FD1;'>수</th>";
    html += "<th style='width:14.28%;font-family:SMSEMyungJoStd-Regular-FD1;'>목</th>";
    html += "<th style='width:14.28%;font-family:SMSEMyungJoStd-Regular-FD1;'>금</th>";
    html += "<th style='width:14.28%;font-family:SMSEMyungJoStd-Regular-FD1;'>토</th>";
    ...
    for(var i=1; i<=max_days; i++)
    {
		...
		var Holiday_obj=['20200815','20200930','20201001','20201002','20201003','20201009','20201225','20210101','20210211','20210212','20210213','20210301','20210505','20210519','20210816','20211004','20211011','20210920','20210921','20210922','20211009','20211225','20220101','20220131','20220201','20220202','20220301','20220505','20220601','20220606','20220815','20220909','20220910','20221003'];
        // 달력의 년월
		...
		if(set_date == this_date){
			html += "<td class=\"content_img\" style=\""+style+"\" onClick=\"calendar_set_date('"+this_date+"');\"><div class='content_imgBox'>"+i+"</div><div class=\"content_imgBoxFont\"></div></td>";
		}else if(Holiday_obj.indexOf(this_date) > -1){

			html += "<td class=\"content_holiday\" style=\""+style+"\" onClick=\"calendar_set_date('"+this_date+"');\">"+i+"</td>";
		}else{
...
function calendar(e, obj_name, fmt,num)
{
    if(!e) var e = window.event;
	obj_num = num;
    ...
    var default_date = document.getElementById('calendar_div_date').value.replace(/[^0-9]/g, '');
